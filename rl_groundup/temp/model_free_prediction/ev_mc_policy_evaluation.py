...
def ev_mc_eval(env, policy, n_episodes):
    usable = {}
    no_usable = {}
    ...
    for i in range(n_episodes):
        ...
        while not done:
            ...
            # Save the state each time it is visited in the episode.
...
if __name__ == '__main__':
    ...
    states_u, states_n, values_u, values_n = ev_mc_eval(env, policy, n_episodes)
